// Where JavaScript code is written
var codingEditor = null;
// Where Blockly is converted to JavaScript
...
window.addEventListener('load', function() {
    ...
    readOnlyCodingEditor.session.setMode('ace/mode/javascript');
    ...
    codingEditor.session.setMode('ace/mode/javascript');
